...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_generos` (
  ...
  `txGenNombre` VARCHAR(45) NOT NULL COMMENT 'Nombre del genero: NOVELAS.....' ,
...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_ejemplares` (
  ...
  `inEjeGenero` INT NOT NULL COMMENT 'Id del genero del libro' ,
...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_grupos` (
  ...
  `inGruNombre` VARCHAR(100) NOT NULL COMMENT 'Nombre del grupo' ,
...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_solicitados` (
  ...
  `txSolObservacion` VARCHAR(100) NULL COMMENT 'Observaciones especificas de la solicitud: No importa el estado, que no este rallado, el de pasta dura...etc.' ,
...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_calificausuarios` (
  ...
  `txCalObservacion` VARCHAR(100) NULL COMMENT 'Comentario anexo a la calificacion' ,
...
CREATE  TABLE IF NOT EXISTS `exdb4read`.`lb_actsesion` (
  ...
  `txActMensaje` VARCHAR(500) NOT NULL COMMENT 'Mensaje de exito / fallo de la acción' ,
